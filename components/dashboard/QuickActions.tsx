          ...
          {quickActions.map((action) => {
            ...
            return (
              <Link
                key={action.href}
                href={action.href}
                className="flex items-center gap-4 p-4 rounded-lg glass border border-gray-800 hover:border-orange-500/40 transition-all duration-200 group"
              >
                ...
                <div className="flex-1">
                  <p className="text-sm font-medium text-gray-200 group-hover:text-orange-400 transition-colors">
                    {action.title}
                  </p>
